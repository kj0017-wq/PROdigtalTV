...
const logoById = {
  "3q": "/assets/official/members/3q.png",
  ...
  "eutelsat-services-beteiligungen": "/assets/official/members/eutelsat.png",
  "farbi-flora": "/assets/official/members/farbi-flora.png",
  "fashion-tv-production": "/assets/official/members/fashion-tv-production.jpg",
  "goldvisite-media": "/assets/official/members/goldbach-germany.jpg",
  ...
  "ors-comm": "/assets/official/members/ors.jpg",
  "red-bull-media-house": "/assets/official/members/red-bull-media-house.jpg",
  "schneider-enterprise": "/assets/official/members/schneider-enterprise.png",
...
const rows = [
  ...
  ["kj-technical-consulting-klaus-juli", "KJ Technical Consulting Klaus Juli", "2026-003", "individual", 180, "Herr", "Klaus", "Juli", "", "Kamillenstrasse 50", "12203", "Berlin", "DE", "kj_privat@yahoo.de", "", "0172 - 3074583", "Sehr geehrter Herr Juli,"],
  ...
  ["ors-comm", "ORS Comm GmbH & Co KG", "2026-005", "company", 800, "Herr", "Michael", "Weber", "", "Hugo-Portisch-Gasse 1", "1136", "Wien", "AT", "invoice@orf.at", "+43 (1) 87040-12942", "", "Sehr geehrter Herr Weber,"],
  ["buero-fuer-moderne-werbung-tv", "Buero fuer moderne Werbung.tv", "2026-006", "individual", 180, "Frau", "Stefanie", "Mobius", "", "Owiesenstrasse 3", "22177", "Hamburg", "DE", "stefanie.moebius@moderne-werbung.tv", "040 - 43020827", "0173 - 2405839", "Sehr geehrte Frau Moebius,"],
  ...
  ["fashion-tv-production", "Fashion tv production UG", "2026-012", "individual", 180, "Frau", "Manuela", "Brodersen Horn", "", "Iserstr. 110", "20149", "Hamburg", "DE", "fashion-tv@t-online.de", "040 - 41467770", "0170 - 2938536", "Sehr geehrte Frau Brodersen Horn,"],
  ...
  ["eutelsat-services-beteiligungen", "Eutelsat Services und Beteiligungen GmbH", "2026-014", "company", 800, "Frau", "Petra", "Konrad", "", "Beethovenstrasse 5-13", "50674", "Koeln", "DE", "petra.konrad@eutelsat.net", "+49 (0) 221 65 00 45 23", "+49 151 42 52 32 31", "Sehr geehrte Frau Konrad,"],
  ...
  ["conrad-heberling", "Prof. Dr Conrad Heberling", "2026-027", "individual", 180, "Herr Prof. Dr", "Conrad", "Heberling", "", "Marlene-Dietrich-Allee 11", "14482", "Potsdam", "DE", "c.heberling@filmuniversitaet.de", "0172953890", "", "Sehr geehrter Herr Prof. Dr Heberling"],
  ...
  ["3q", "3Q Medien", "2026-029", "company", 800, "Herr", "Julius", "Thomas", "", "Belfortstr. 5", "10711", "Muenchen", "DE", "kreditoren@3q.video", "+4930120833020", "", "Sehr geehrter Herr Thomas"],
...
function memberRecord(row, sortOrder) {
  ...
  return {
    ...
    personalSalutation,
    logoUrl: logoById[id] || "",
    description: "Internes Mitgliedsprofil aus der Mitgliederliste 2026.",
    status: "active",
