...
const profileTexts = new Map(Object.entries({
  ...
  "blu-tec-one": "BLU TEC ONE ist ein Medien- und Technikunternehmen von Volker Blume aus Tangstedt. Die öffentliche Website befindet sich derzeit im Aufbau; das Profil bleibt deshalb bewusst knapp.",
  ...
  "fashion-tv-production": "Fashion tv production arbeitet im Umfeld von Mode, Fernsehen und Bewegtbildproduktion. Das Profil bleibt knapp, bis weitere belastbare Webinformationen verfügbar sind.",
  "goldbach-germany": "Goldvisite ist im Umfeld von Medien, Vermarktung und Kommunikation tätig. Das Profil wird knapp gehalten, bis auf dem verlinkten Webauftritt weitere Details eindeutig verfügbar sind.",
  ...
  "idee-medien": "Idee Medien entwickelt und begleitet Medien- und Kommunikationsprojekte. Das Profil bleibt bewusst kurz, bis der Webauftritt weitere belastbare Leistungsdetails liefert.",
  "itsmaxsuhr": "itsmaxsuhr steht für persönliche Medien-, Kommunikations- und Beratungsleistungen. Das Profil wird knapp geführt, bis aus dem Webauftritt weitere Details eindeutig ableitbar sind.",
  ...
  "major-seven-consulting": "Major Seven Consulting begleitet Strategie-, Medien- und Kommunikationsprojekte. Das Profil bleibt kurz, bis die Website weitere belastbare Leistungsdetails liefert.",
  "moderne-werbung": "Büro für moderne Werbung.tv arbeitet im Umfeld von Werbung, Medien und TV-Kommunikation. Das Profil wird knapp gehalten, bis der Webauftritt weitere Details bestätigt.",
  ...
  "schneider-enterprise": "Schneider-Enterprise unterstützt Medien- und Digitalprojekte mit Beratung, Netzwerk und operativer Erfahrung. Das Profil bleibt bewusst kompakt.",
  "sebastian-labonte": "Sebastian Labonte arbeitet im Umfeld von Medien, Kommunikation und Beratung. Das Profil wird knapp geführt, bis aus dem Webauftritt weitere Details eindeutig belegbar sind.",
  ...
  "tv-2000plus": "TV.2000Plus arbeitet im Umfeld von Fernsehen, Medien und Bewegtbildkommunikation. Das Profil bleibt kurz, bis der Webauftritt weitere belastbare Details liefert."
}));
