...
export const accessLabels = {
  public: "Für alle Interessierten",
...
export const events = [
  ...
  },
  {
    ...
    postEventSummary: "Mit dem Medienfruehstueck in der Leica-Welt setzte PROdigitalTV den Branchendialog am 13. Januar 2026 in Wetzlar fort. Das Ernst-Leitz Museum bildete den Rahmen für Austausch und persoenliche Vernetzung.",
  ...
  },
  {
    ...
    sponsorIds: [],
    hostId: "red-bull-members-club",
    postEventSummary: "Am 19. und 20. November 2025 brachte PROdigitalTV Mitglieder und Gaeste in Salzburg zusammen. Der Red Bull Members Club Hangar 7 bot einen besonderen Rahmen für das Medienfruehstueck und den fachlichen Austausch.",
...
function officialArchiveEvent(officialId, date, title, locationName, city, options = {}) {
  ...
  return {
    ...
    postEventSummary: options.summary || `${title} ist als Rückblick im PROdigitalTV-Archiv erfasst. Die Veranstaltung steht für Dialog, Austausch und Vernetzung in der digitalen Medienwirtschaft.`,
...
export const additionalArchiveEvents = [
  ...
  officialArchiveEvent("13", "2015-06-08", "Jahreshauptversammlung für Mitglieder", "", "Koeln", { accessType: "members_only", eventType: "Mitgliederveranstaltung" }),
  ...
  officialArchiveEvent("66", "2023-09-27", "Rabatt für die MediaTech Hub Conference 2023", "MediaTech Hub Conference", "Potsdam", { accessType: "members_only", eventType: "Mitgliederveranstaltung" }),
  officialArchiveEvent("67", "2023-09-27", "Rabatt für die MediaTech Hub Conference 2023 (Archivdatensatz)", "MediaTech Hub Conference", "Potsdam", { accessType: "members_only", eventType: "Mitgliederveranstaltung" })
];
...
export const topics = [
  ...
  },
  {
    ...
    longDescription: "Systeme und Prozesse für skalierbare Mediaprodukte.",
    articleText: "Content Management ist in der digitalen Medienwirtschaft weit mehr als die Pflege einzelner Webseiten. Inhalte muessen geplant, produziert, versioniert, beschrieben, freigegeben, verteilt und ausgewertet werden. Je mehr Kanaele, Plattformen und Ausspielwege hinzukommen, desto wichtiger wird eine robuste Content-Architektur. Ohne saubere Prozesse verlieren Organisationen Geschwindigkeit, Qualitaet und Uebersicht.\n\nEin modernes Content-Management-System muss redaktionelle Arbeit, technische Metadaten und betriebliche Anforderungen zusammenbringen. Dazu gehoeren Rollen und Rechte, Medienverwaltung, strukturierte Inhalte, Barrierefreiheit, Mehrsprachigkeit, Suchmaschinenoptimierung, Schnittstellen und Archivlogik. Besonders im Bewegtbildumfeld spielen Transcodierung, Untertitel, Rechtefenster, Vorschaubilder, Kapitelmarken und Distribution an externe Plattformen eine zentrale Rolle.\n\nDie eigentliche Herausforderung liegt haeufig nicht in der Software, sondern in der Organisation. Wer entscheidet, wann ein Inhalt veroeffentlicht wird? Welche Daten sind Pflicht? Wie werden alte Inhalte aktualisiert? Welche Inhalte duerfen intern bleiben, welche sind oeffentlich, welche exklusiv für Mitglieder oder Partner? Gute Systeme machen diese Regeln sichtbar und einfach bedienbar.\n\nPROdigitalTV betrachtet Content Management als Infrastruktur für professionelle Medienangebote. Effiziente Workflows schaffen Freiraum für redaktionelle Qualitaet und strategische Entwicklung. Im Netzwerk koennen Unternehmen Erfahrungen austauschen, technische Anforderungen schaerfen und zeigen, wie skalierbare Systeme die Zusammenarbeit zwischen Redaktion, Marketing, Vertrieb, Technik und Management verbessern.\n\nWichtig ist dabei eine klare Trennung zwischen Inhalt, Design und Ausspielung. Strukturierte Inhalte lassen sich leichter wiederverwenden, personalisieren und archivieren. Das erhoeht die Lebensdauer redaktioneller Arbeit und reduziert Doppelpflege. Gute Content-Management-Prozesse verbessern ausserdem Compliance, weil Freigaben, Rechte und Aenderungen nachvollziehbar bleiben. Für Organisationen, die Veranstaltungen, Mitglieder, Medien und redaktionelle Inhalte parallel betreuen, wird Content Management damit zum Rueckgrat der digitalen Kommunikation. Es entscheidet, wie professionell eine Plattform nach innen und aussen arbeitet.\n\nGerade für eine Branchenplattform zeigt sich der Wert solcher Strukturen im Alltag. Events, Referenten, Sponsoren, Mitglieder, Bilder und Nachberichte koennen nur dann konsistent erscheinen, wenn Inhalte einmal sauber erfasst und danach flexibel ausgespielt werden. Besonders wertvoll wird dies, wenn Inhalte spaeter für Archiv, Newsletter, Eventkommunikation und Mitgliederbereich erneut genutzt werden.",
  ...
  },
  {
    ...
    articleText: "Addressable TV verbindet die Reichweite und Markenqualitaet des Fernsehens mit der Zielgenauigkeit digitaler Werbung. Werbung kann in geeigneten technischen Umgebungen dynamischer, regionaler oder zielgruppenspezifischer ausgespielt werden, ohne den Charakter hochwertiger TV-Umfelder aufzugeben. Für Werbekunden entsteht dadurch die Moeglichkeit, Kampagnen praeziser zu planen und Streuverluste zu reduzieren.\n\nFür Sender und Vermarkter bietet Addressable TV neue Erlospotenziale. Gleichzeitig steigen die Anforderungen an Technologie, Datenqualitaet, Consent, Messung und Kreation. Spots, Overlays oder interaktive Formate muessen zur Nutzungssituation passen und duerfen das Vertrauen in das Programmumfeld nicht beschaedigen. Die Balance zwischen Relevanz und Zurueckhaltung ist entscheidend.\n\nBesonders wichtig ist die Frage, welche Daten genutzt werden duerfen und wie transparent dies gegenueber Nutzerinnen und Nutzern geschieht. Datenschutz und Akzeptanz sind keine Nebenthemen, sondern Voraussetzungen für nachhaltige Geschaeftsmodelle. Auch technische Fragmentierung bleibt eine Herausforderung: Geraete, Plattformen, HbbTV-Versionen und Vermarktungssysteme muessen zusammenspielen.\n\nPROdigitalTV betrachtet Addressable TV als Schnittstelle zwischen klassischer TV-Staerke und digitaler Weiterentwicklung. Das Thema verbindet Sender, Plattformen, Agenturen, Technologieanbieter und Regulierung. Im Branchendialog geht es darum, Standards zu verstehen, Erfolgsmodelle zu vergleichen und hochwertige Werbung in digitalen TV-Umgebungen so zu gestalten, dass sie für Nutzer, Anbieter und Werbekunden Mehrwert schafft.\n\nDie weitere Entwicklung wird stark davon abhaengen, wie einfach Addressable-TV-Kampagnen buchbar, messbar und vergleichbar werden. Werbekunden erwarten digitale Steuerbarkeit, aber auch die Verlaesslichkeit klassischer TV-Umfelder. Anbieter muessen daher technische Komplexitaet reduzieren und gleichzeitig Qualitaet sichern. Kreative Formate sollten nicht nur Daten nutzen, sondern echten Kontext verstehen. Wenn Relevanz, Datenschutz und Nutzererlebnis zusammenspielen, kann Addressable TV ein wichtiger Baustein für die Zukunft der Bewegtbildvermarktung werden.\n\nFür Medienanbieter entsteht daraus eine klare Aufgabe: Sie muessen Technologie, Daten und Kreation so verbinden, dass Werbung wirksamer wird, ohne das Programmumfeld zu entwerten. Professionelle Standards und gemeinsames Lernen sind dafür entscheidend. Für die Branche bleibt wichtig, Nutzervertrauen nicht als gegeben anzusehen. Transparenz und Qualitaet entscheiden, ob adressierbare Werbung akzeptiert wird.",
...
export const currentDemoMembers = [];
...
export const eventMedia = [
  {
    ...
    description: "Eventbild für das PROdigitalTV Medienfruehstueck im Hangar-7 Salzburg.",
...
export const galleries = [
  ...
  },
  {
    ...
    description: "Allgemeine Bildergalerie für redaktionelle Rückblicke und Veranstaltungsbeitraege.",
    status: "draft",
    visibility: "internal",
    images: [],
    createdAt: "2026-05-26T10:00:00",
...
function pressArticleFromEvent(event, index = 0) {
  ...
  const bodyText = [
    event.postEventSummary || event.description || `${event.title} ist als Rückblick im PROdigitalTV-Archiv erfasst.`,
    location || dateLabel
  ...
  return {
    ...
    title: `Rückblick: ${event.title}`,
    subtitle: event.subtitle || `${event.eventType || "PROdigitalTV-Veranstaltung"} im Rückblick`,
    introText,
    bodyText,
    category: "Rückblicke",
...
export const editorialContent = [
  ...
  { id: "press-hangar7-salzburg-2026", key: "press.hangar7.2026", page: "press", section: "pressRelease", title: "PROdigitalTV Medienfruehstueck im Hangar-7", subtitle: "Branchendialog in Salzburg mit Gaesten aus Medien, Technik und Vermarktung.", introText: "PROdigitalTV laedt zum Medienfruehstueck im Red Bull Hangar-7 nach Salzburg ein.", bodyText: "Das Medienfruehstueck bringt Entscheiderinnen und Entscheider aus TV, Streaming, Produktion, Technologie und Vermarktung zusammen. Im Mittelpunkt stehen aktuelle Fragen der digitalen Medienwirtschaft: Wie entwickeln sich Plattformen, welche Rolle spielen neue Distributionsmodelle, und wie koennen Anbieter ihre Inhalte sichtbar und wirtschaftlich tragfaehig positionieren?\n\nDer Austausch im Netzwerk soll Orientierung geben und konkrete Erfahrungen aus der Branche sichtbar machen. PROdigitalTV versteht das Format als kompakten Rahmen für Wissenstransfer, persoenliche Begegnung und neue Kooperationen.", category: "Presse", publishDate: "2026-05-20", validFrom: "2026-05-20", validTo: "", visibility: "public", visible: true, status: "published", sortOrder: 10 },
  ...pressRetrospectiveArticles,
  { id: "news-ki-medienwirtschaft", key: "news.ki.medienwirtschaft", page: "news", section: "news", title: "KI bleibt ein zentrales Thema der Medienwirtschaft", subtitle: "Redaktion, Produktion und Distribution brauchen klare Regeln für KI-Werkzeuge.", introText: "Kuenstliche Intelligenz veraendert Arbeitsablaeufe in Redaktion, Produktion und Auswertung.", bodyText: "KI-Werkzeuge koennen Medienunternehmen bei Recherche, Transkription, Untertitelung, Archivsuche und Content-Planung unterstuetzen. Gleichzeitig steigen die Anforderungen an Kontrolle, Transparenz und Verantwortung.\n\nFür die Branche ist entscheidend, dass automatisierte Prozesse nicht zu ungeprueften Aussagen, unklaren Quellen oder rechtlichen Risiken fuehren. PROdigitalTV betrachtet KI deshalb als strategisches Thema, das Technik, Redaktion, Recht und Management gemeinsam betrifft.", category: "KI", publishDate: "2026-05-22", validFrom: "2026-05-22", validTo: "", visibility: "public", visible: true, status: "published", sortOrder: 11 },
  { id: "news-fast-channels-distribution", key: "news.fast.distribution", page: "news", section: "news", title: "FAST-Channels gewinnen als Distributionsmodell an Bedeutung", subtitle: "Lineare Streaming-Angebote schaffen neue Optionen für Reichweite und Vermarktung.", introText: "FAST-Channels verbinden kuratierte Programme mit digitaler Ausspielung.", bodyText: "Werbefinanzierte lineare Streaming-Kanaele koennen vorhandene Inhalte neu buendeln und Zielgruppen in digitalen Umgebungen erreichen. Für Anbieter entstehen Chancen bei Reichweite, Markenbildung und Vermarktung.\n\nEntscheidend bleiben redaktionelle Programmierung, verlaessliche Technik, Rechteklaerung und klare Messbarkeit. Damit wird FAST nicht nur zu einem technischen, sondern auch zu einem strategischen Thema für Medienanbieter und Plattformen.", category: "Distribution", publishDate: "2026-05-24", validFrom: "2026-05-24", validTo: "", visibility: "public", visible: true, status: "published", sortOrder: 12 },
  { id: "member-article-jhv-2024", key: "member.article.jhv2024", page: "portal", section: "videos", title: "Jahreshauptversammlung 2024", subtitle: "Rückblick auf die Mitgliederversammlung und die wichtigsten Impulse für das Netzwerk.", introText: "Die Jahreshauptversammlung 2024 brachte Mitglieder von PROdigitalTV zum Austausch ueber Vereinsarbeit, digitale Medienwirtschaft und die naechsten Schritte des Netzwerks zusammen.", bodyText: "Die Jahreshauptversammlung 2024 war ein zentraler Termin für die Mitglieder von PROdigitalTV. Im Mittelpunkt standen der Rückblick auf die Vereinsarbeit, aktuelle Entwicklungen in der digitalen Medienwirtschaft und die Frage, wie das Netzwerk seine Rolle als Plattform für Austausch, Orientierung und Kooperation weiter schaerfen kann.\n\nNeben formalen Tagesordnungspunkten bot die Versammlung Raum für Gespraeche ueber Branchenthemen, Mitgliederbedarfe und neue Formate. Besonders deutlich wurde, dass der persoenliche Austausch innerhalb des Netzwerks auch in einer zunehmend digitalen Medienwelt ein wichtiger Erfolgsfaktor bleibt.\n\nDas begleitende Video ist oben als Titelmedium eingebunden. Es wird erst nach Klick geladen und steht angemeldeten Mitgliedern exklusiv im Mitgliederbereich zur Verfuegung.", category: "Mitgliederbeitrag", publishDate: "2026-06-17", validFrom: "2026-06-17", validTo: "", visibility: "members", visible: true, status: "published", sortOrder: 1, videoAttachments: [{ id: "video-jhv-2024", youtubeVideoId: "e6yj_afboyE", youtubeUrl: "https://youtu.be/e6yj_afboyE?is=SaMM6MtEe-RjSBHy", embedUrl: "https://www.youtube.com/embed/e6yj_afboyE", title: "Jahreshauptversammlung 2024", caption: "Video zur Jahreshauptversammlung 2024", description: "", posterImageUrl: "https://img.youtube.com/vi/e6yj_afboyE/hqdefault.jpg", posterImageAlt: "Video zur Jahreshauptversammlung 2024 starten", posterImageCaption: "", posterImageSource: "youtube_thumbnail", youtubeThumbnailUrl: "https://img.youtube.com/vi/e6yj_afboyE/hqdefault.jpg", sourceType: "youtube_import", privacyStatus: "unlisted", visibility: "public", status: "ready", uploadStatus: "ready", sortOrder: 1 }] },
  ...topicalNewsArticles,
  { id: "about-intro", key: "about.intro", page: "about", section: "intro", title: "Das Branchennetzwerk der digitalen Medienwirtschaft.", introText: "PROdigitalTV vernetzt Unternehmen und Akteure der digitalen Medienwirtschaft im deutschsprachigen Raum.", bodyText: "PROdigitalTV e.V. vernetzt Unternehmen und Akteure der digitalen Medienwirtschaft im deutschsprachigen Raum und begleitet die Branche aktiv im digitalen Wandel. In einer Zeit, in der sich Mediennutzung, Technologien und Geschaeftsmodelle rasant verändern, schaffen wir eine Plattform für Austausch, Kooperation und praxisnahes Lernen. Unsere Mitglieder kommen aus den Bereichen TV, Streaming, Plattformen, Produktion, Distribution, Technologie, Start-ups und Medienservices - verbunden durch das gemeinsame Ziel, die Zukunft digitaler Medien aktiv mitzugestalten.\n\nDer Verein foerdert den Dialog zwischen etablierten Marktteilnehmern und innovativen Unternehmen, unterstuetzt den Wissenstransfer zu aktuellen Entwicklungen und bietet Raum für neue Ideen und Partnerschaften. Durch Veranstaltungen wie Medienfruehstuecke, Fachgespraeche und Interviewformate wie \"Von den Besten lernen\" entstehen wertvolle Kontakte und Impulse zu Themen wie digitale Transformation, Content-Strategien, neue Technologien, Monetarisierung, KI, Streaming oder die Zukunft des Fernsehens.\n\nMitglieder profitieren von einem starken Netzwerk, hoher Branchenkompetenz und einer Plattform, die den persoenlichen Austausch in den Mittelpunkt stellt. Gleichzeitig unterstuetzt PROdigitalTV die Sichtbarkeit seiner Mitglieder innerhalb der Medienbranche und schafft Verbindungen zwischen Technologie, Content und Vermarktung. Für TV-Sender bietet der Verein darueber hinaus die Moeglichkeit, von einem Vereinsrabatt bei der GEMA zu profitieren.\n\nPROdigitalTV versteht sich als unabhaengiges Netzwerk und Impulsgeber für die digitale Medienwelt - offen, praxisorientiert und zukunftsgerichtet.", validFrom: "", validTo: "", visibility: "public", status: "published", sortOrder: 1 },
  ...
  { id: "download-info-satzung", key: "join.downloadInfo.satzung", page: "join", section: "internal", title: "Vereinssatzung", bodyText: "Die Vereinssatzung regelt Zweck, Mitgliedschaft, Organe und grundlegende Arbeitsweise von PROdigitalTV e.V. Bitte lesen Sie die Satzung vor dem Absenden des Mitgliedsantrags.", validFrom: "", validTo: "", visibility: "public", status: "published", sortOrder: 2, downloadId: "download-satzung", download_id: "download-satzung" },
  { id: "download-info-membership-fees", key: "join.downloadInfo.membershipFees", page: "join", section: "internal", title: "Mitgliederbeitraege", bodyText: "Die Beitragsuebersicht informiert ueber die aktuellen Mitgliedsbeitraege für Unternehmensmitglieder und Einzelmitglieder. Die Angaben dienen als Grundlage für den Mitgliedsantrag.", validFrom: "", validTo: "", visibility: "public", status: "published", sortOrder: 3, downloadId: "download-membership-fees", download_id: "download-membership-fees" },
  ...
  { id: "join-benefit-impulses", key: "join.benefit.impulses", page: "join", section: "internal", title: "Impulse", bodyText: "Der Verein schafft Raum für Wissenstransfer, Austausch und praxisnahe Impulse zu Digitalisierung, Content, Plattformen, Technologie und Medienstrategie.", validFrom: "", validTo: "", visibility: "public", status: "published", sortOrder: 6 },
  { id: "footer-downloads", key: "footer.downloads", page: "join", section: "footer", title: "Downloads", bodyText: "Downloadbereich für Vereinssatzung und Mitgliederbeitraege.", validFrom: "", validTo: "", visibility: "public", status: "published", sortOrder: 4 },
  ...
  { id: "footer-cookie-settings", key: "footer.cookieSettings", page: "legal", section: "footer", title: "Cookie Einstellungen", bodyText: "Cookie-Einstellungen für die Website.", validFrom: "", validTo: "", visibility: "public", status: "published", sortOrder: 6 },
  { id: "footer-login", key: "footer.login", page: "login", section: "footer", title: "Log-In", bodyText: "Login für Mitglieder und Redaktionszugriff.", validFrom: "", validTo: "", visibility: "public", status: "published", sortOrder: 7 },
...
export const settings = [
  { id: "accessTypes", key: "accessTypes", group: "events", value: ["public", "members_only", "invitation_only"], description: "Zugangsarten für Events" },
  { id: "eventTypes", key: "eventTypes", group: "events", value: ["Fachgespraech", "Konferenz", "Medienfruehstueck", "Mitgliederveranstaltung", "Netzwerkveranstaltung", "Panel", "Roundtable", "Summit", "Webinar", "Workshop"], description: "Eventtypen für CMS-Auswahl" },
...
export const verified_sources = [
  { id: "verified-source-eu-commission", name: "Europaeische Kommission", domain: "ec.europa.eu", url: "https://commission.europa.eu", source_type: "Behoerde", source_status: "bevorzugt", category: "Plattformregulierung", trust_score: 95, language: "de/en", country: "EU", notes: "Primaerquelle für EU-Regulierung.", priority: 1, default_for_categories: ["Plattformregulierung", "Barrierefreiheit", "Medienrecht"], created_at: "2026-05-29T10:00:00", updated_at: "2026-05-29T10:00:00", checked_at: "2026-05-29T10:00:00", checked_by: "System" },
  ...
  { id: "verified-source-hbbtv", name: "HbbTV Association", domain: "hbbtv.org", url: "https://www.hbbtv.org", source_type: "Technischer Standard", source_status: "bevorzugt", category: "HbbTV", trust_score: 92, language: "en", country: "international", notes: "Primaerquelle für HbbTV-Standards.", priority: 2, default_for_categories: ["HbbTV", "Smart-TV", "Streaming-Technologie"], created_at: "2026-05-29T10:00:00", updated_at: "2026-05-29T10:00:00", checked_at: "2026-05-29T10:00:00", checked_by: "System" },
  { id: "verified-source-w3c", name: "W3C", domain: "w3.org", url: "https://www.w3.org", source_type: "Technischer Standard", source_status: "bevorzugt", category: "Webstandards", trust_score: 96, language: "en", country: "international", notes: "Technische Standards für Web und Medien.", priority: 2, default_for_categories: ["Streaming-Technologie", "Barrierefreiheit", "Untertitel"], created_at: "2026-05-29T10:00:00", updated_at: "2026-05-29T10:00:00", checked_at: "2026-05-29T10:00:00", checked_by: "System" },
  { id: "verified-source-gema", name: "GEMA", domain: "gema.de", url: "https://www.gema.de", source_type: "Verwertungsgesellschaft", source_status: "erlaubt", category: "Musikrechte", trust_score: 88, language: "de", country: "DE", notes: "Quelle für Musikrechte und GEMA-Informationen.", priority: 3, default_for_categories: ["Musikrechte", "GEMA", "Verwertungsrecht"], created_at: "2026-05-29T10:00:00", updated_at: "2026-05-29T10:00:00", checked_at: "2026-05-29T10:00:00", checked_by: "System" }
];
...
export const media_assets = [
  ...
  ...currentDemoMembers.map((member) => mediaAssetFromRecord(member, "members", "member", "logoUrl")),
...
export const memberDocuments = [
  ...
  },
  {
    ...
    year: "2025",
    meetingDate: "2026-06-08",
    description: "Ablage für das Protokoll der Jahreshauptversammlung zum Vorjahr.",
    documentUrl: "",
    visibility: "members",
    status: "published",
    createdAt: "2026-06-08T10:00:00",
  ...
  },
  {
    ...
    year: "2025",
    description: "Interner Kassenbericht für das Vorjahr.",
    documentUrl: "",
    visibility: "members",
    status: "published",
    createdAt: "2026-06-08T10:00:00",
...
export const demoDatabase = {
  events: [...events, ...additionalArchiveEvents], topics, speakers, sponsors, members: currentDemoMembers, boardMembers, registrations, membershipApplications, downloads, eventMedia, galleries,
